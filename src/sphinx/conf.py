...
html_logo = "_static/img/home.png"
...
latex_documents = [
    (master_doc, 'SSBL.tex', 'SSBL Documentation',
     'SICK AG', 'manual'),
]
...
man_pages = [
    (master_doc, 'ssbl', 'SSBL Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SSBL', 'SSBL Documentation',
     author, 'SSBL', 'One line description of project.',
     'Miscellaneous'),
]
